...
fun RootNavGraph(
    ...
    when (userTokenState) {
        ...
        is State.Success -> {
            ...
            val initialDestination = if (userTokenStateResult?.userToken?.accessToken.isNullOrBlank())  Graph.AUTH else Graph.HOME
            NavHost(navController = navController, route = Graph.ROOT, startDestination = initialDestination) {
...
fun HomeGraph(
    ...
    NavHost(navController = navController, route = Graph.HOME, startDestination = ScreenRoutes.ChatsScreen.route, modifier = Modifier.padding(innerPaddings)) {
...
fun NavGraphBuilder.authNavGraph(
    ...
    navigation(
        ...
        composable(route = ScreenRoutes.SmsCodeScreen.route,
