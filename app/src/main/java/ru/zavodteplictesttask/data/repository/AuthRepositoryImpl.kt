...
class AuthRepositoryImpl @Inject constructor(
    ...
    override suspend fun register(phone: String, name: String, username: String): ApiResult<Register> {
        return when(val result = remoteDataSource.register(name = name, username = username, phone = phone)) {
            is ApiResult.Success -> {
                val entity = result.data.asEntity()
                localDataSource.saveTokenData(
                    refreshToken = entity.refreshToken ?: "",
